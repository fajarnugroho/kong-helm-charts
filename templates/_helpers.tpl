...
{{- if .Values.postgresql.external }}
  {{- $_ := set $autoEnv "KONG_PG_HOST" .Values.postgresql.service.host | default "postgresql" -}}
  {{- $_ := set $autoEnv "KONG_PG_PORT" .Values.postgresql.service.port | default "5432" -}}
  {{- $pgPassword := include "secretkeyref" (dict "name" .Values.postgresql.secretName "key" "postgresql-password") -}}
